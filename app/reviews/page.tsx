  ...
  return (
    <div className="min-h-dvh">
      ...
      <main className="mx-auto max-w-5xl px-4 py-12">
        ...
        <section className="mt-8 rounded-2xl border border-brand-100 bg-brand-50/50 p-6 sm:p-8">
        ...
        {reviews.length === 0 ? (
          <div className="mt-12 rounded-2xl border border-brand-100 bg-white p-10 text-center">
          ...
          <div className="mt-12">
            <h2 className="text-2xl font-bold text-ink">Recent reviews</h2>
            <div className="mt-6">
